...
export function NodesView() {
  ...
  return (
    <>
      <PageHeader
        title="Network Nodes"
        description="Explore all nodes running in the Codex network. Each node replicates and reprovides publication data, increasing the resiliency of the network."
      ...
      <PageContainer>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Geographic distribution of nodes across the network. For
              preserving privacy, the locations are not exact.
            </CardDescription>
          </CardHeader>
          <CardContent>
